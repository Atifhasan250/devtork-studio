  ...
  return (
    <form className="contact-form" onSubmit={submit} noValidate>
      ...
      <div className="field-row">
        ...
        <div className="field"><label htmlFor="budget">Estimated budget</label><select id="budget" name="budget" defaultValue=""><option value="">Choose a range</option><option>Under $2,000</option><option>$2,000–$5,000</option><option>$5,000–$10,000</option><option>$10,000–$25,000</option><option>$25,000+</option><option>Need help defining it</option></select></div>
      </div>
