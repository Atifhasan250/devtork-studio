...
export const metadata: Metadata = { title: "Services", description: "UI/UX design, web development, mobile apps, brand identity, SEO, growth, and ongoing digital support." };
