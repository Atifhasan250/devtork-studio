      ...
      <section className="hero">
        <div className="container hero-grid">
          <div>
            ...
            <div className="hero-actions"><Link className="btn" data-magnetic href="/contact">Start a project <span className="btn-icon">↗</span></Link><Link className="btn btn-outline" data-magnetic href="/work">View works</Link></div>
          </div>
          <HeroVisual />
        </div>
      </section>
