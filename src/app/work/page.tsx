...
export default function WorkPage() {
  return (
    <>
      ...
      <section className="section section-purple big-cta"><div className="container big-cta-inner"><div><p className="eyebrow">Your project could be next</p><h2>Bring us the goal. We’ll help shape the right digital experience.</h2><a className="cta-pill" href="/contact"><span className="cta-pill-circle"><span>→&#xFE0E;</span></span><span className="cta-pill-text">Start project</span></a></div></div></section>
    </>
  );
}
