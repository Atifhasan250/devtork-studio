...
export default async function CaseStudyPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      ...
      <section className="section section-purple big-cta"><div className="container big-cta-inner"><Link href={`/work/${nextProject.slug}`}><p className="eyebrow">Next project</p><h2>{nextProject.name}</h2><div className="cta-pill"><span className="cta-pill-circle"><span>→&#xFE0E;</span></span><span className="cta-pill-text">View case</span></div></Link></div></section>
    </>
  );
}
