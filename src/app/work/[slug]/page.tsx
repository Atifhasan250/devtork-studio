    ...
    <>
      <section className="case-hero">
        ...
        <div className="case-cover">
          <div className="parallax-media" data-parallax data-parallax-speed="0.045"><div className={`work-art ${project.artClass}`} /></div>
        </div>
      </section>
      ...
      <section className="section"><div className="container"><div className="case-gallery"><div className="case-gallery-item wide"><div className="parallax-media" data-parallax data-parallax-speed="0.035"><div className={`work-art ${project.artClass}`} /></div></div><div className="case-gallery-item"><div className="parallax-media" data-parallax data-parallax-speed="0.03"><div className="work-art art-identity" /></div></div><div className="case-gallery-item"><div className="parallax-media" data-parallax data-parallax-speed="0.03"><div className="work-art art-impact" /></div></div></div></div></section>
