...
export default async function CaseStudyPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      ...
      <section className="section section-purple big-cta"><div className="container big-cta-inner"><Link href={`/work/${nextProject.slug}`}><p className="eyebrow">Next project</p><h2>{nextProject.name}</h2><div className="cta-circle"><span>View<br />case ↗&#xFE0E;</span></div></Link></div></section>
    </>
  );
}
