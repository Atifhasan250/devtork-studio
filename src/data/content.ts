...
export const services = [
  ...
  { id: "brand", number: "04", title: "Brand identity", summary: "We create the visual and verbal system that helps people recognise your business and understand what makes it different.", items: ["Brand direction", "Logo system", "Colour & typography", "Tone of voice", "Guidelines"], outcome: "A consistent identity that works across your website, product, social content, and presentations." },
  { id: "growth", number: "05", title: "SEO & growth", summary: "We help the right people find your business and make the path from attention to action easier to measure.", items: ["Technical SEO", "Content planning", "Analytics", "Paid campaigns", "Conversion improvement"], outcome: "A practical growth system built around useful data instead of vague promises." },
  { id: "support", number: "06", title: "Ongoing support", summary: "Launch is not the end. We can keep the website secure, updated, measured, and ready for new needs.", items: ["Maintenance", "Security updates", "Content support", "Performance checks", "Continuous improvement"], outcome: "A digital presence that stays useful and improves instead of slowly becoming outdated." }
] as const;
